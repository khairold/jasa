...
export default () => (
  ...
  >
    <div
      sx={{ fontSize: [3, 4], fontWeight: 600, lineHeight: 1, color: "orange" }}
    >
    ...
    <div sx={{ py: 4 }}>
      <div sx={{ display: "flex", alignItems: "flex-start", mb: 3 }}>
        ...
        <div sx={{ display: "inline-block" }}>
          Kendalikan pelan pasca bayar mudah alih anda sendiri kerana anda tidak
          terikat dengan sebarang kontrak
        </div>
      </div>
      <div sx={{ display: "flex", alignItems: "flex-start", mb: 3 }}>
        <img
